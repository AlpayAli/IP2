...
VALUES ('23222222-4522-2222-2222-672222222222', 'ProfilePlayer', 100, 500.0, 'profilePlayer@example.com', true, true,
        'https://storage.googleapis.com/image_bucket_ip2/general/winter-find-game.png');
...
VALUES (gen_random_uuid(), 'Win with a Royal Flush', 'Win a round with a Royal Flush', 500, 'ROYAL_FLUSH'),
...
VALUES (gen_random_uuid(), 'Table background 2', 50, 5000,
        'https://storage.googleapis.com/image_bucket_ip2/general/table-bg/2.png'),
       (gen_random_uuid(), 'Table background 3', 150, 5500,
        'https://storage.googleapis.com/image_bucket_ip2/general/table-bg/3.png'),
       (gen_random_uuid(), 'Table background 4', 250, 6000,
        'https://storage.googleapis.com/image_bucket_ip2/general/table-bg/4.png'),
       (gen_random_uuid(), 'Table background 5', 350, 6500,
        'https://storage.googleapis.com/image_bucket_ip2/general/table-bg/5.png'),
       (gen_random_uuid(), 'Table background 6', 450, 7000,
        'https://storage.googleapis.com/image_bucket_ip2/general/table-bg/6.png'),
       (gen_random_uuid(), 'Table background 7', 550, 7500,
        'https://storage.googleapis.com/image_bucket_ip2/general/table-bg/7.png'),
       (gen_random_uuid(), 'Table background 8', 650, 8000,
        'https://storage.googleapis.com/image_bucket_ip2/general/table-bg/8.png'),
       (gen_random_uuid(), 'Table background 9', 750, 8500,
        'https://storage.googleapis.com/image_bucket_ip2/general/table-bg/9.png'),
       (gen_random_uuid(), 'Table background 10', 850, 9000,
        'https://storage.googleapis.com/image_bucket_ip2/general/table-bg/10.png'),
       (gen_random_uuid(), 'Table background 11', 950, 9500,
        'https://storage.googleapis.com/image_bucket_ip2/general/table-bg/11.png'),
       (gen_random_uuid(), 'Table background 12', 1000, 10000,
        'https://storage.googleapis.com/image_bucket_ip2/general/table-bg/12.png');
